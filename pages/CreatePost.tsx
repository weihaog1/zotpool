...
import { Car, User, Calendar, DollarSign, Info } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-6">
               ...
               <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    disabled
                    value="UCI Main Campus"
                    className="w-full p-4 border border-slate-200 bg-slate-100 text-slate-500 rounded-2xl font-medium cursor-not-allowed"
                  />
               </div>
            </div>
          </div>
            ...
            <>
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-slate-700 ml-1">Seats Available</label>
                        <select 
                            value={seats}
