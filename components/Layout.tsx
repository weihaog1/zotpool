    ...
    <div className="min-h-screen flex flex-col relative bg-slate-50/50">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-4 px-4 pointer-events-none">
        <nav className="glass rounded-full shadow-xl shadow-slate-200/50 pointer-events-auto w-full max-w-5xl mx-auto transition-all duration-300">
            ...
            {isMobileMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 mt-2 mx-4 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-100 p-4 space-y-2 animate-in slide-in-from-top-4 fade-in duration-200">
                {user ? (
                <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                <div className="bg-uci-gold p-1.5 rounded-lg">
                    <Car className="text-uci-dark h-5 w-5" />
                </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-slate-400">
                <li><a href="#" className="hover:text-uci-gold transition-colors">How it Works</a></li>
                <li><a href="#" className="hover:text-uci-gold transition-colors">Safety</a></li>
                <li><a href="#" className="hover:text-uci-gold transition-colors">Community Guidelines</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-display font-bold mb-6 text-white tracking-wide text-sm uppercase">Legal</h3>
              <ul className="space-y-4 text-slate-400">
                <li><a href="#" className="hover:text-uci-gold transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-uci-gold transition-colors">Terms of Service</a></li>
                <li><a href="#" className="hover:text-uci-gold transition-colors">Contact Support</a></li>
              </ul>
            </div>
          </div>
